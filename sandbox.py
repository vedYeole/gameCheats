# optimizing wordhuntwinner using sets
from icecream import ic # ice cream so good, gang gang

def badLettersInWord(unusedLetters:set, word:str) -> bool:
    wordSet = set(word)
